...
public class UserController {
    ...
    public ResponseEntity<Map<String, String>> registerUser(UserRegisterRequest request){
    ...
    @PostMapping("/login")
    public ResponseEntity<Map<String,String>> loginUser(UserLoginRequest request){
