...
The Product Microservice has features like:-

1. Admin can add or create new products.
2. Admin can view available products.
3. Admin can update/soft delete available products.
4. Customer can access or get necessary product information.
